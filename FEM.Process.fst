...
val find_context_equality : bool -> genv -> term -> list term_view -> list term_view -> Tac (genv & option term)
let rec find_context_equality dbg ge0 tm parents children =
  match parents with
  | [] -> ge0, None
  | tv :: parents' ->
    ...
    | Tv_Let _ _ bv' def _ ->
      ...
      | _, None -> find_context_equality dbg ge0 tm parents' (tv :: children)
      end
   | _ -> find_context_equality dbg ge0 tm parents' (tv :: children)
